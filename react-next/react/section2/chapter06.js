...
console.log(arr_test.pop()); // 3이 출력

// shift

console.log(arr_test.shift()); // 1이 출력 -> shift는 배열의 첫번째 값을 추출하고 삭제

// unshift

arr_test.unshift(0, -1, -2); // unshift는 배열의 앞에 값을 추가

// slice

// 배열 자르기

console.log(arr_test.slice(0, -1)); // 첫번째부터 배열의 마지막의 이전값까지

console.log(`배열의 마지막 : ${arr_test.slice(-1)}`);

// concat

// 배열을 이어주는 것

arr_test2 = [123, 456, 789];

const arr_3 = arr_test.concat(arr_test2); // 기존의 배열에 영향을 끼치지 않는다. 
